...
export const buildableProducts: BuildableProduct[] = [
  ...
  },
  {
    ...
    description: "Escolha seis porções de frutas e acrescente seus favoritos.",
    basePrice: 10,
    includes: ["500 ml", "6 porções de frutas", "adicionais por R$ 1"],
    available: true,
  },
];
...
export const ingredientCategories: IngredientCategory[] = [
  ...
  },
  {
    ...
    ingredients: [
      ...
      { id: "acai-fruta-uva", name: "Uva", portion: "1 porção", price: 0, badge: "Só hoje", nutrition: zero, available: true },
  ...
  },
  {
    id: "tamanho-frutas",
    name: "Tamanho",
    helper: "Um pote de 500 ml com seis porções de frutas.",
    selection: "single",
    required: true,
    included: 0,
    appliesTo: ["salada-frutas"],
    ingredients: [
      { id: "frutas-500", name: "500 ml", portion: "6 porções de frutas", price: 10, nutrition: zero, available: true },
    ],
  },
  {
    id: "frutas-salada",
    name: "Quais frutas vão no seu pote?",
    helper: "Escolha seis porções. Você pode repetir suas favoritas.",
    selection: "multiple",
    required: true,
    included: 6,
    appliesTo: ["salada-frutas"],
    ingredients: [
      { id: "sf-banana", name: "Banana", portion: "1 porção", price: 0, nutrition: { calories: 53, protein: 0.7, carbs: 13.7, fat: 0.2 }, available: true },
      { id: "sf-melao", name: "Melão", portion: "1 porção", price: 0, nutrition: { calories: 18, protein: 0.4, carbs: 4.5, fat: 0.1 }, available: true },
      { id: "sf-mamao", name: "Mamão", portion: "1 porção", price: 0, nutrition: { calories: 22, protein: 0.3, carbs: 5.5, fat: 0.1 }, available: true },
      { id: "sf-maca", name: "Maçã", portion: "1 porção", price: 0, nutrition: { calories: 26, protein: 0.1, carbs: 7, fat: 0.1 }, available: true },
      { id: "sf-uva", name: "Uva", portion: "1 porção", price: 0, nutrition: { calories: 35, protein: 0.4, carbs: 9, fat: 0.1 }, available: true },
      { id: "sf-manga", name: "Manga", portion: "1 porção", price: 0, nutrition: { calories: 30, protein: 0.4, carbs: 7.5, fat: 0.2 }, available: false },
      { id: "sf-kiwi", name: "Kiwi", portion: "1 porção", price: 0, nutrition: { calories: 31, protein: 0.6, carbs: 7.5, fat: 0.3 }, available: false },
      { id: "sf-abacaxi", name: "Abacaxi", portion: "1 porção", price: 0, nutrition: { calories: 25, protein: 0.3, carbs: 6.5, fat: 0.1 }, available: true },
      { id: "sf-morango", name: "Morango", portion: "1 porção", price: 0, nutrition: { calories: 19, protein: 0.4, carbs: 4.6, fat: 0.2 }, available: true },
    ],
  },
  {
    id: "adicionais-frutas",
    name: "Quer dar um toque a mais?",
    helper: "Cada adicional custa mais R$ 1,00.",
    selection: "multiple",
    required: false,
    included: 0,
    appliesTo: ["salada-frutas"],
    ingredients: [
      { id: "sf-granola", name: "Granola", portion: "1 porção", price: 1, nutrition: { calories: 93, protein: 2.3, carbs: 13.3, fat: 3.3 }, available: true },
      { id: "sf-leite-condensado", name: "Leite condensado", portion: "1 porção", price: 1, nutrition: { calories: 64, protein: 1.6, carbs: 11, fat: 1.7 }, available: true },
      { id: "sf-leite-po", name: "Leite em pó", portion: "1 porção", price: 1, nutrition: { calories: 75, protein: 3.8, carbs: 5.8, fat: 4 }, available: true },
    ],
  },
];
